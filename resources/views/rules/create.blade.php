...
<div class="container">
    <div class="row">
        ...
        {!! Form::model(['action' => 'RuleEngineController@store']) !!}
        <div class="form-group">
        {!! Form::label('monthlyBudget', 'Budget $', ['class' => 'lead']) !!} 
        {!! Form::text('monthlyBudget', $monthlyBudget, ['class' => 'form-control col-xs-4' ]) !!}
        <div>CharityQ allows you to optionally select criteria based on your donation preferences. Donation not meeting you selected criteria or that would be over budget will be flagged as "pending rejection" to guide when reviewing requests.</div>
        </div>
